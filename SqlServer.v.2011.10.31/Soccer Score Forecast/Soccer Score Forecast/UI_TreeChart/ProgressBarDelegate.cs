...
namespace Soccer_Score_Forecast
{
    ...
    public static class Conn
    {
        public static string conn = @"Data Source=localhost;Initial Catalog=G:\htmlconvertsql\match_analysis_pdm.mdf;Integrated Security=True";
        ...
        public static bool CreateTable(Type linqTableClass)
        {
            ...
            //混淆以后反射名称被改变出现问题
            using (DataClassesMatchDataContext localdb = new DataClassesMatchDataContext(Conn.conn))
            {
                try
                {
    ...
    public static class Conn_sqlcompact
    {
        ...
        public static bool CreateTable_sqlcompact(Type linqTableClass)
        {
            bool suc = true;
            string createtable = linqTableClass.Name;
            //MessageBox.Show(createtable);
