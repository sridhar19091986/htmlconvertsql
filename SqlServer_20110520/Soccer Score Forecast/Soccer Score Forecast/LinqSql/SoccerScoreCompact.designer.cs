...
namespace SoccerScore.Compact.Linq
{
	...
	public partial class Match_analysis_result : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<double> _Cross_goals;
    ...
    partial void OnCross_goalsChanging(System.Nullable<double> value);
    ...
    partial void OnPnn_fitChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="cross_goals", Storage="_Cross_goals", DbType="Float")]
		public System.Nullable<double> Cross_goals
		{
			get
			{
				return this._Cross_goals;
			}
			set
			{
				if ((this._Cross_goals != value))
				{
					this.OnCross_goalsChanging(value);
					this.SendPropertyChanging();
					this._Cross_goals = value;
					this.SendPropertyChanged("Cross_goals");
					this.OnCross_goalsChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="myfit", Storage="_Myfit", DbType="NVarChar(20)")]
		public string Myfit
		{
			get
			{
			...
			set
			{
				if ((this._Myfit != value))
				{
					this.OnMyfitChanging(value);
					this.SendPropertyChanging();
					this._Myfit = value;
					this.SendPropertyChanged("Myfit");
					this.OnMyfitChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="recent_scores", Storage="_Recent_scores", DbType="Int")]
		public System.Nullable<int> Recent_scores
		{
			get
			{
				return this._Recent_scores;
			}
			set
			{
				if ((this._Recent_scores != value))
				{
					this.OnRecent_scoresChanging(value);
					this.SendPropertyChanging();
