...
{
  /// <summary>
  /// The CurveFitComclass class provides a CLS compliant interface to the M-functions
  ...
  /// @Version 0.0
  /// </remarks>
  public class CurveFitComclass : IDisposable
    {
      #region Constructors
          ...
          if (MWArray.MCRAppInitialized)
            {
              ...
              mcr= new MWMCR(MCRComponentState.MCC_CurveFitCom_name_data,
                             MCRComponentState.MCC_CurveFitCom_root_data,
                             MCRComponentState.MCC_CurveFitCom_public_data,
                             MCRComponentState.MCC_CurveFitCom_session_data,
                             MCRComponentState.MCC_CurveFitCom_matlabpath_data,
                             MCRComponentState.MCC_CurveFitCom_classpath_data,
                             MCRComponentState.MCC_CurveFitCom_libpath_data,
                             MCRComponentState.MCC_CurveFitCom_mcr_application_options,
                             MCRComponentState.MCC_CurveFitCom_mcr_runtime_options,
                             MCRComponentState.MCC_CurveFitCom_mcr_pref_dir,
                             MCRComponentState.MCC_CurveFitCom_set_warning_state,
                             ctfFilePath, true);
            }
          else
            {
      ...
      /// <summary>
      /// Constructs a new instance of the CurveFitComclass class.
      /// </summary>
      public CurveFitComclass()
        {
        }
